...
//   { id: 3, name: 'Call Center Team A',code: 'CC-A',  description: 'Inbound leads and initial qualification',                  is_active: true,  created_at: '2024-03-10' },
...
//   { id: 4, team_id: 2, employee_id: 7, role: 'team_leader', is_team_leader: true,  is_active: true,  created_at: '2024-02-01' },
//   { id: 5, team_id: 3, employee_id: 3, role: 'supervisor',  is_team_leader: true,  is_active: true,  created_at: '2024-03-10' },
//   { id: 6, team_id: 3, employee_id: 4, role: 'sales_rep',   is_team_leader: false, is_active: false, created_at: '2024-04-20' },
// ];
...
//     if (!dept) return FALLBACK_DEPT_STYLE;
//     return { bg: dept.bg, color: dept.color };
//   },
...
//     if (i === -1) return null;
//     MOCK_EMPLOYEES[i] = { ...MOCK_EMPLOYEES[i], ...updates, id: MOCK_EMPLOYEES[i].id, created_at: MOCK_EMPLOYEES[i].created_at };
//     return MOCK_EMPLOYEES[i];
//   },
//   deleteEmployee(id) {
//     const i = MOCK_EMPLOYEES.findIndex((e) => e.id === parseInt(id));
//     if (i === -1) return false; MOCK_EMPLOYEES.splice(i, 1); return true;
//   },
...
//   deleteTeam(id) {
//     const i = MOCK_TEAMS.findIndex((t) => t.id === parseInt(id));
//     if (i === -1) return false; MOCK_TEAMS.splice(i, 1); return true;
//   },
//   getTeamMemberCount(teamId) {
...
//     MOCK_TEAM_MEMBERS.push(m); return m;
//   },
//   updateTeamMember(id, updates) {
//     const i = MOCK_TEAM_MEMBERS.findIndex((m) => m.id === parseInt(id));
//     if (i === -1) return null;
//     MOCK_TEAM_MEMBERS[i] = { ...MOCK_TEAM_MEMBERS[i], ...updates, id: MOCK_TEAM_MEMBERS[i].id, is_team_leader: (updates.role || MOCK_TEAM_MEMBERS[i].role) === 'team_leader', created_at: MOCK_TEAM_MEMBERS[i].created_at };
//     return MOCK_TEAM_MEMBERS[i];
//   },
//   deleteTeamMember(id) {
//     const i = MOCK_TEAM_MEMBERS.findIndex((m) => m.id === parseInt(id));
//     if (i === -1) return false; MOCK_TEAM_MEMBERS.splice(i, 1); return true;
//   },
//   isEmployeeInTeam(employeeId, teamId) {
...
export const HRDataService = {
  ...
  getSalesEmployees() {
    ...
    return MOCK_EMPLOYEES.filter(e => e.department === salesId);
  },
  createEmployee(data) {
    const e = { id: nextEmployeeId++, created_at: new Date().toISOString().split('T')[0], is_active: true, ...data };
    MOCK_EMPLOYEES.push(e); return e;
