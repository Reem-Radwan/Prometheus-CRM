...
// Convert +20XXXXXXXXX → 01XXXXXXXXX for display
        ...
        <CardContent sx={{ p: 4 }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        error={!!errors.phone}
                        helperText={errors.phone?.message || 'Egyptian mobile number'}
                      />
                    )}
                  />
                </Grid>
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
              <Button variant="outlined" size="large" onClick={() => navigate('/partners')} disabled={isSubmitting} sx={{ minWidth: '120px' }}>
                Cancel
              </Button>
