...
export default function CampaignEdit() {
  ...
  const {
    ...
    defaultValues: {
      name: '', platform_id: '', budget: '', start_date: '', end_date: '', is_active: true,
    },
  });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      MarketingDataService.updateCampaign(Number(id), payload);
      ...
      <Card sx={{ maxWidth: '800px', mx: 'auto' }}>
        <CardContent sx={{ p: 4 }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {platformStyle && (
              <Paper elevation={0} sx={{ p: 3, mb: 4, backgroundColor: platformStyle.bg,
                border: `1px solid ${platformStyle.color}30`, borderRadius: '12px' }}>
